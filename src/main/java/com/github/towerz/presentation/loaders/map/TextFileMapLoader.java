...
import com.github.towerz.game.engine.loaders.MapLoader;
import com.github.towerz.game.world.GameMap;
import com.github.towerz.game.world.PathSegment;
import com.github.towerz.game.world.Tile;
...
import static com.github.towerz.presentation.config.Dimensions.WORLD_TO_REAL_POSITION_TRANSLATION;
...
public class TextFileMapLoader implements MapLoader {
    ...
    public GameMap load() {
        ...
        return new GameMap(
                ...
                worldSize,
                Gameplay.CREATURE_STEPS_PER_TILE,
                tiles,
                path,
                pathSegments);
    }
